...
class Forum extends React.Component {
    ...
    render() {
        ...
        const {config, toggleSidebar, navigation, screenProps: { t }} = this.props;


        return (
            <ThemedView isFullView>
                <Header centerComponent={<TextHeader title={t('common:text_forum')} />} rightComponent={<CartIcon />} />
                {/* <Header
                    leftComponent={
                        toggleSidebar ? (
                            <IconHeader
                ...
                <ScrollView>
                    <Text>Próximamente aquí estarán los foros...</Text>
                </ScrollView>
